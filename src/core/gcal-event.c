                                   ...
                                   GTimeZone **out_end_timezone)
{
  ...
  for (property = i_cal_component_get_first_property (icalcomp, I_CAL_X_PROPERTY);
       ...
       g_object_unref (property), property = i_cal_component_get_next_property (icalcomp, I_CAL_X_PROPERTY))
    {
      ...
      if (g_strcmp0 (i_cal_property_get_x_name (property), "X-Lingmo-CALENDAR-ORIGINAL-TZ-START") == 0)
        {
          value = i_cal_property_get_x (property);
          original_start_tz = g_time_zone_new_identifier (value);

          GCAL_TRACE_MSG ("Found X-Lingmo-CALENDAR-ORIGINAL-TZ-START=%s", value);
        }
      else if (g_strcmp0 (i_cal_property_get_x_name (property), "X-Lingmo-CALENDAR-ORIGINAL-TZ-END") == 0)
        {
          value = i_cal_property_get_x (property);
          original_end_tz = g_time_zone_new_identifier (value);

          GCAL_TRACE_MSG ("Found X-Lingmo-CALENDAR-ORIGINAL-TZ-END=%s", value);
        }
    }
 ...
 * into separate, Lingmo Calendar specific fields. These fields can
      ...
      if (g_strcmp0 (i_cal_property_get_x_name (property), "X-Lingmo-CALENDAR-ORIGINAL-TZ-START") == 0)
        {
          ...
          GCAL_TRACE_MSG ("Reusing X-Lingmo-CALENDAR-ORIGINAL-TZ-START property with %s", i_cal_property_get_x (property));
      ...
      else if (g_strcmp0 (i_cal_property_get_x_name (property), "X-Lingmo-CALENDAR-ORIGINAL-TZ-END") == 0)
        {
          ...
          GCAL_TRACE_MSG ("Reusing X-Lingmo-CALENDAR-ORIGINAL-TZ-END property with %s", i_cal_property_get_x (property));
  ...
  if (!has_original_start_tz)
    {
      ...
      i_cal_property_set_x_name (property, "X-Lingmo-CALENDAR-ORIGINAL-TZ-START");

      GCAL_TRACE_MSG ("Added new X-Lingmo-CALENDAR-ORIGINAL-TZ-START property with %s", i_cal_property_get_x (property));
  ...
  if (!has_original_end_tz)
    {
      tz = g_date_time_get_timezone (self->dt_end);
      property = i_cal_property_new_x (g_time_zone_get_identifier (tz));
      i_cal_property_set_x_name (property, "X-Lingmo-CALENDAR-ORIGINAL-TZ-END");

      GCAL_TRACE_MSG ("Added new X-Lingmo-CALENDAR-ORIGINAL-TZ-END property with %s", i_cal_property_get_x (property));
