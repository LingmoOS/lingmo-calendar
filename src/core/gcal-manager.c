 ...
 * @short_description: The backend of Lingmo Calendar
 * @title:GcalManager
 * @stability:unstable
 *
 * #GcalManager is the backend of Lingmo Calendar. It sets everything
 ...
 * @self: a #GcalManager
 *
 * Retrieves the default timeline of Lingmo Calendar.
 *
