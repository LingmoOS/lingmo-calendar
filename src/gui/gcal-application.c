                             ...
                             gpointer       user_data)
{
  ...
  const gchar *developers[] = {
    "Erick Pérez Castellanos <erickpc@lingmo.org>",
  ...
  about = g_object_new (ADW_TYPE_ABOUT_WINDOW,
                        ...
                        "version", VERSION,
                        "copyright", copyright,
                        "website", "https://wiki.lingmo.org/Apps/Calendar",
                        "issue-url", "https://gitlab.gnome.org/GNOME/lingmo-calendar/-/issues/new",
                        "support-url", "https://discourse.lingmo.org/tag/calendar",
                                       ...
                                       GVariantDict *options)
{
  ...
  if (show_version)
    {
      g_print ("lingmo-calendar: Version %s\n", PACKAGE_VERSION);
      return 0;
    }
...
gcal_application_new (void)
{
  return g_object_new (gcal_application_get_type (),
                       "resource-base-path", "/org/lingmo/calendar",
