                   ...
                   GcalCalendar      *calendar)
{
  ...
  builder = gtk_builder_new_from_resource ("/org/lingmo/calendar/ui/gui/calendar-management/calendar-row.ui");
...
gcal_calendars_page_class_init (GcalCalendarsPageClass *klass)
{
  ...
  gtk_widget_class_set_template_from_resource (widget_class, "/org/lingmo/calendar/ui/gui/calendar-management/gcal-calendars-page.ui");
