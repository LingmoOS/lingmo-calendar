 ...
 *
 * #GcalCalendarManagementDialog is the calendar management widget of Lingmo
...
gcal_calendar_management_dialog_class_init (GcalCalendarManagementDialogClass *klass)
{
  ...
  gtk_widget_class_set_template_from_resource (widget_class, "/org/lingmo/calendar/ui/gui/calendar-management/gcal-calendar-management-dialog.ui");
