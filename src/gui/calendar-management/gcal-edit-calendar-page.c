                               ...
                               GcalEditCalendarPage *self)
{
  ...
  gcal_utils_launch_lingmo_settings (g_application_get_dbus_connection (app),
                                    "online-accounts",
...
gcal_edit_calendar_page_class_init (GcalEditCalendarPageClass *klass)
{
  ...
  gtk_widget_class_set_template_from_resource (widget_class, "/org/lingmo/calendar/ui/gui/calendar-management/gcal-edit-calendar-page.ui");
