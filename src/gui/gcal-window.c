/* gcal-window.c
 *
 * Copyright (C) 2015 Erick Pérez Castellanos <erickpc@lingmo.org>
 * Copyright (C) 2014-2020 Georges Basile Stavracas Neto <georges.stavracas@gmail.com>
 *
 * lingmo-calendar is free software: you can redistribute it and/or modify it
 * under the terms of the GNU General Public License as published by the
 * Free Software Foundation, either version 3 of the License, or
 * (at your option) any later version.
 *
 * lingmo-calendar is distributed in the hope that it will be useful, but
...
/**
 * SECTION:gcal-window
 * @short_description: Main window of Lingmo Calendar
 * @title:GcalWindow
 * @stability:unstable
 * @image:gcal-window.png
 *
 * #GcalWindow is the main window of Lingmo Calendar, and contains
                                      ...
                                      gpointer       user_data)
{
  ...
  gcal_utils_launch_lingmo_settings (connection, "datetime", NULL);
}
                                   ...
                                   gpointer       user_data)
{
  ...
  gcal_utils_launch_lingmo_settings (connection, "online-accounts", NULL);
}
...
gcal_window_class_init (GcalWindowClass *klass)
{
  ...
  gtk_widget_class_set_template_from_resource (widget_class, "/org/lingmo/calendar/ui/gui/gcal-window.ui");
