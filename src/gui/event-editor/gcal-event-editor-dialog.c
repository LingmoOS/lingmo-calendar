 ...
 *
 * #GcalEventEditorDialog is the event editor dialog of Lingmo Calendar. It
...
gcal_event_editor_dialog_class_init (GcalEventEditorDialogClass *klass)
{
  ...
  gtk_widget_class_set_template_from_resource (widget_class, "/org/lingmo/calendar/ui/event-editor/gcal-event-editor-dialog.ui");
